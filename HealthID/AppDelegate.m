...
- (void)userLoggedIn{
    ...
    DashboardViewController *dVC = [storyoard instantiateViewControllerWithIdentifier:@"DashboardViewController"];
    [(UINavigationController *)self.window.rootViewController pushViewController:dVC animated:NO];
}
